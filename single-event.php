			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
						...
						<div id="main" class="m-all t-all d-all cf" role="main">
							...
							<article id="event-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">

								<header class="article-header event-header">

									<h1 class="page-title event-title" itemprop="headline"><?php the_title(); ?></h1>
