...
function soblossom_supports_wp_features() {
	...
	*/
	 ...
	 * The Site Logo feature allows you to add a logo to your Jetpack-powered site, and have it persist between theme switches.
	 * Any theme that supports it will display the logo in its own unique way, consistent with that theme’s design.
